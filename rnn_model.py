...
class SentenceVAE(nn.Module):
    ...
    def forward(self, input_sequence, length):
        ...
        #print("ENCODER PACKED_INPUT" + packed_input + "\n")
        ...
        #print("DECODER PACKED_INPUT" + packed_input + "\n")
        ...
        #print("OUTPUTS2VOCAB: "+str((padded_outputs.view(-1, padded_outputs.size(2))).size()))
