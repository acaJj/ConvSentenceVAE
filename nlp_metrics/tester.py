...
if __name__ == '__main__':
    ...
    hypo_rnn_file = glob.glob('hypo_rnn/*')
    ref_rnn_file = glob.glob('ref_rnn/*')
    hypo_cnn_file = glob.glob('hypo_cnn/*')
    ref_cnn_file = glob.glob('ref_cnn/*')
    ...
    ROUGE_L = 0.
    num_files = 0
    for reference_file, hypothesis_file in zip(ref_rnn_file, hypo_rnn_file):
        num_files += 1
